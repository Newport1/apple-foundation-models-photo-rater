...
This repo is a small experimental shell utility for first-pass photo review. It loops through local image files, sends each image to `fm respond --image`, asks for a quality score, extracts the numeric rating, and writes the result to a CSV file.
